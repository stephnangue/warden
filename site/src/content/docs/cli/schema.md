...
[`path-help`](/cli/path-help/), and the same schema backs `-D/--dry-run` validation.
...
- [`warden path-help`](/cli/path-help/) — human-readable help for a path or backend.
- [Dry run](/cli/#dry-run) — local payload validation against this schema.
