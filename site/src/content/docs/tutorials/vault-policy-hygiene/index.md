---
title: "OpenBao Policy Hygiene Audit with Goose, via Warden"
---
...
in [docs/agent-flow.md](/agent-flow/), demonstrated end-to-end
...
The `bao-seed` service from step 2 runs [`bao-seed.sh`](https://github.com/stephnangue/warden/blob/main/site/src/content/docs/tutorials/vault-policy-hygiene/bao-seed.sh) inside
...
The entire section is automated by [`warden-init.sh`](https://github.com/stephnangue/warden/blob/main/site/src/content/docs/tutorials/vault-policy-hygiene/warden-init.sh)
...
[docs/agent-flow.md §1](/agent-flow/): the runtime injects the
...
The recipe is staged at [`policy-hygiene.yaml`](https://github.com/stephnangue/warden/blob/main/site/src/content/docs/tutorials/vault-policy-hygiene/policy-hygiene.yaml) in
...
[`.forgejo/workflows/hygiene.yaml`](https://github.com/stephnangue/warden/blob/main/site/src/content/docs/tutorials/vault-policy-hygiene/.forgejo/workflows/hygiene.yaml) in
...
[docs/agent-flow.md §1](/agent-flow/) plus the one LLM-leg
override:
...
Forward link: `vault-policy-least-privilege.md`
...
mount — see [aws-access-hygiene](/tutorials/aws-access-hygiene/).
