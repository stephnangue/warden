---
title: "02 — Certificate → Warden → LLM + MCP"
---
...
certificate from [01](/quickstarts/workstation/01-cert-llm/): one identity, a new role in the URL path, and Warden
...
[01, Steps 3 & 5](/quickstarts/workstation/01-cert-llm/#step-3--route-the-anthropic-api-through-warden).
...
> referenced from the [series README](/quickstarts/workstation/). Each follows the same shape: mount the
