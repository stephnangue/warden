---
title: "03 — SPIFFE → Warden → LLM + MCP (zero credentials)"
---
...
[01](/quickstarts/workstation/01-cert-llm/) and [02](/quickstarts/workstation/02-cert-llm-mcp/): Steps 1–5 stand up the keyless SPIFFE
...
really run — see the [series README](/quickstarts/workstation/) for the upcoming **Kubernetes** (cluster
