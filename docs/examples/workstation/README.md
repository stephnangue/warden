# Securing agents on the workstation — a Warden tutorial series
...
|---|----------|-----------|-----------------------------------------------------|------|
| [01](01-cert-llm/) | mTLS cert · *key on disk* | LLM (Anthropic) | the **LLM API key** | ~15 min |
| [02](02-cert-llm-mcp/) | mTLS cert · *key on disk* | LLM + **GitHub MCP** | + the **GitHub MCP token** | ~20 min |
| [03](03-spiffe-llm-mcp/) | SPIFFE SVID · *keyless* | LLM + **GitHub MCP** | + the **mTLS private key** → **nothing left** | ~30 min |
...
Start at **[01](01-cert-llm/)** even if SPIFFE is your goal — it introduces the
