# main.tf
# Main configuration for SNS Comprehensive Test Suite
...
terraform {
  ...
  backend "s3" {
    ...
    key    = "sns-tests/terraform.tfstate"
    region = "us-east-1"
  }
}
...
output "name_prefix" {
  ...
  description = "The name prefix used for all SNS resources"
}
