...
// tlsSettings is the TLS configuration of the transport to Azure.
func (b *azureBackend) tlsSettings() (skipVerify bool, caData string) {
	b.mu.RLock()
	defer b.mu.RUnlock()
...
func (b *azureBackend) setTLSSettings(skipVerify bool, caData string) {
	b.mu.Lock()
	defer b.mu.Unlock()
