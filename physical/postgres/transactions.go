...
func (b *PostgreSQLStorage) newTransaction(ctx context.Context, readOnly bool) (physical.Transaction, error) {
...
func (b *PostgreSQLStorage) BeginTx(ctx context.Context) (physical.Transaction, error) {
	return b.newTransaction(ctx, false)
}

func (b *PostgreSQLStorage) BeginReadOnlyTx(ctx context.Context) (physical.Transaction, error) {
	return b.newTransaction(ctx, true)
}

func (t *PostgreSQLStorageTransaction) Put(ctx context.Context, entry *physical.Entry) error {
	t.l.Lock()
	defer t.l.Unlock()
...
func (t *PostgreSQLStorageTransaction) Delete(ctx context.Context, fullPath string) error {
	t.l.Lock()
	defer t.l.Unlock()
...
func (t *PostgreSQLStorageTransaction) Get(ctx context.Context, fullPath string) (*physical.Entry, error) {
	t.l.Lock()
	defer t.l.Unlock()
...
func (t *PostgreSQLStorageTransaction) List(ctx context.Context, prefix string) ([]string, error) {
	t.l.Lock()
	defer t.l.Unlock()
...
func (t *PostgreSQLStorageTransaction) ListPage(ctx context.Context, prefix string, after string, limit int) ([]string, error) {
	t.l.Lock()
	defer t.l.Unlock()
...
func (t *PostgreSQLStorageTransaction) Commit(ctx context.Context) error {
...
func (t *PostgreSQLStorageTransaction) Rollback(ctx context.Context) error {
	t.l.Lock()
	defer t.l.Unlock()
