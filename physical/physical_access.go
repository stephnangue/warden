...
// PhysicalAccess is a wrapper around physical.Storage that allows Core to
...
var _ Storage = (*PhysicalAccess)(nil)

func NewPhysicalAccess(physical Storage) *PhysicalAccess {
