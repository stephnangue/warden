...
// cacheIdentity literals in the ...MintDeferred, ...ResourceDerived,
// ...ResourceOverrideAndOptOut and ...RoleIsolatesCacheIdentity tests above are the
// byte-for-byte proof that keys predating this fragment did not move.
