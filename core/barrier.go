...
var (
	...
	//nolint:staticcheck // Warden is a proper name
	ErrBarrierSealed = errors.New("Warden is sealed")

	// ErrBarrierAlreadyInit is returned if the barrier is already
	// initialized. This prevents a re-initialization.
	//nolint:staticcheck // Warden is a proper name
	ErrBarrierAlreadyInit = errors.New("Warden is already initialized")

	// ErrBarrierNotInit is returned if a non-initialized barrier
	// is attempted to be unsealed.
	//nolint:staticcheck // Warden is a proper name
	ErrBarrierNotInit = errors.New("Warden is not initialized")
...
// SecurityBarrier is a critical component of Warden. It is used to wrap
...
// a Warden. The barrier should only be Unlockable given its key.
