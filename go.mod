...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/redshiftserverless v1.35.2
...
// v2.0.0 was never tagged for these sub-modules; redirect to the earliest valid tag
replace (
	github.com/openbao/openbao/api/auth/approle/v2 v2.0.0 => github.com/openbao/openbao/api/auth/approle/v2 v2.0.1
	github.com/openbao/openbao/api/auth/userpass/v2 v2.0.0 => github.com/openbao/openbao/api/auth/userpass/v2 v2.0.1
)
